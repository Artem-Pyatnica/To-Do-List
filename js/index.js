...
function setDefaultState() {
  ...
  baseState[id] = {
    status: "new",
    id: id,
    title: "Цей сайт використовує 🍪 для зберігання ваших задач"
  };
  syncState(baseState);
}
...
function addItem(text, status, id, noUpdate) {
  ...
  $(".form-control")
    .val("")
    .attr("placeholder", "✍️ Додати задачу...");
  setTimeout(function() {
...
var randomWordArray = Array(
  ...
  "То це вже ",
  "Цей день настав - ",
  "Скоріше б відпочити, а поки що ",
  "Продовжуємо працю, бо ",
  "Невпинно плине ",
  "Насолоджуйся, поки "
);
